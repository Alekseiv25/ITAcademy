...
//Tabs
let tab = function() {
    let tabNav = document.querySelectorAll(".tabs-nav-item"), tabContent = document.querySelectorAll(".clothes-content"), tabName;
    tabNav.forEach((item)=>{
...
//Change language
tab();
(0, _jqueryDefault.default)(".item-lang").click(function() {
    (0, _jqueryDefault.default)(".item-lang").removeClass("selected");
    (0, _jqueryDefault.default)(this).addClass("selected");
});
(0, _jqueryDefault.default)(".list-item").click(function() {
    (0, _jqueryDefault.default)(".list-item").removeClass("selected");
    (0, _jqueryDefault.default)(this).addClass("selected");
});
//Accordion
(0, _jqueryDefault.default)(document).ready(function() {
    (0, _jqueryDefault.default)(".acc-menu .acc-head").on("click", f_acc);
});
function f_acc() {
    (0, _jqueryDefault.default)(this).toggleClass("_active");
    (0, _jqueryDefault.default)(this).next().slideToggle(1000);
}
//Slick slider
(0, _jqueryDefault.default)(".carousel").slick({
    arrows: false,
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 2,
...
(0, _jqueryDefault.default)(".slider").slick({
    arrows: false,
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
...
if (iconMenu) {
    ...
    if (closeBurger) closeBurger.addEventListener("click", function() {
        burgerBody.classList.remove("_active");
    });
}

},{"jquery":"hgMhh","slick-carousel":"ghMFH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"ghMFH":[function(require,module,exports) {
(function(factory) {
    "use strict";
...
},{"jquery":"hgMhh"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["7age3","3cYfC"], "3cYfC", "parcelRequire8c00")

//# sourceMappingURL=tailoring.b8fca702.js.map
